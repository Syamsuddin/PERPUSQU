...
@section('title', 'Tambah Jenis Koleksi')
@section('page-title', 'Tambah Jenis Koleksi')
@section('breadcrumb')
...
<div class="card shadow-sm border-0"><div class="card-body">
    <form method="POST" action="{{ route('admin.master-data.collection-types.store') }}">@csrf
        @include('modules.master_data.collection_types._form')
