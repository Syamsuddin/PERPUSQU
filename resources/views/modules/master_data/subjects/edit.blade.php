...
@section('page-title', 'Edit Subjek')
@section('breadcrumb')
...
<div class="card shadow-sm border-0"><div class="card-body">
    <form method="POST" action="{{ route('admin.master-data.subjects.update', $subject) }}">@csrf @method('PUT')
        @include('modules.master_data.subjects._form', ['item' => $subject])
